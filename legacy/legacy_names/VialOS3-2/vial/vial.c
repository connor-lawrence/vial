...
void os_main() {
    if (os_mode == OS_TERMINAL_MODE) {
        ...
        print("[ ", VGA_LIGHT_GRAY, 0);
        print("VialOS ", VGA_LIGHT_BLUE, 0);
...
void print_banner() {
    ...
    print(" VialOS Dev ", VGA_LIGHT_BLUE, 0);
    print("with CorK 2.2", VGA_RED, 0);
    print("    /   _____  \\    /  _______\\ \n", VGA_LIGHT_BLUE, 0);
    print(" x86-32 - VGA Text Driver", VGA_GREEN, 0);
    print("       \\  \\     \\  \\  /  /\n", VGA_LIGHT_BLUE, 0);
